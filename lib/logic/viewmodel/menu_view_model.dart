...
class MenuViewModel {
  ...
  getMenuItems() {
    return menuItems = <Menu>[
      Menu(title: "Profile", menuColor: Color(0xff050505), icon: Icons.person, image: UIData.profileImage, items: ["View Profile", "Profile 2", "Profile 3", "Profile 4"]),
      Menu(title: "Nintendo Switch Store", menuColor: Color(0xffc8c4bd), icon: Icons.store, image: UIData.shoppingImage, items: ["Shopping List", "Shopping Details", "Product Details", "Shopping 4"]),
      Menu(title: "Nintendo News", menuColor: Color(0xffc7d8f4), icon: Icons.message, image: UIData.loginImage, items: ["Login With OTP", "Login 2", "Sign Up", "Login 4"]),
      ...
      Menu(title: "Settings", menuColor: Color(0xff2a8ccf), icon: Icons.settings, image: UIData.settingsImage, items: ["Device Settings", "Settings 2", "Settings 3", "Settings 4"]),
